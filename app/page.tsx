...
type SortKey = "selected" | "date" | "complaints" | "service" | "location" | "region" | "suggestion" | "state" | "team";
...
export default function Home() {
  ...
  const filteredSorted = useMemo(() => {
    ...
    return [...filtered].sort((a, b) => {
      ...
      if (sortKey === "region") comparison = a.region.localeCompare(b.region, "pt-BR");
  ...
  function changeSort(key: SortKey) {
    ...
    else { setSortKey(key); setSortDirection(key === "service" || key === "location" || key === "region" || key === "state" || key === "team" ? "asc" : "desc"); }
    setPage(1);
  }
